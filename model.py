...
app = Flask(__name__)
app.secret_key = b'\xcc^\x98\xea\x71-\xd0W\x04\xa2\xf1J0\xac6\xc9'
CORS(app)

@app.route('/predict/<select_league>/<ht>/<at>', methods=['GET'])
def PredictScore(select_league,ht,at,):
    folder='/Users/ashwini/Documents/GitHub/genesis/football_predictor/datasets/'+select_league+'/'
    ...
    os.chdir('/Users/ashwini/Documents/GitHub/genesis/football_predictor/datasets/'+select_league+'/')
    extension = 'csv'
